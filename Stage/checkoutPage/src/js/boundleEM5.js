...
(function () {
   ...
   */
    ...
    */
		...
		var sumProd = $('.summary-product');
		var container = $('.container');
		var content = $('.content');

		var detailsProducts = function detailsProducts() {
			if (sumProd.find('.show-product').hasClass('hide')) {
				var temp5 = $('#temp-show-products').html();
		...
		var showChoose = function showChoose(th) {
			th.addClass('play');
			...
			if (th.hasClass('choose1')) {
				...
				if (th.hasClass('choose2')) {
					...
					var temp4 = $('#temp-store-country').html();
